        ...
        <div className={containerClass}>
          <section className={cardClass}>
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                <h1 className="text-3xl font-bold text-[var(--ownly-text)] md:text-5xl">
                  Payments
                </h1>
              ...
              <button
                type="button"
                className="rounded-2xl border border-blue-500/30 bg-blue-500/10 px-5 py-3 text-sm font-semibold text-[var(--ownly-primary)] transition hover:border-blue-500/60 hover:bg-blue-500/20"
              >
                Stripe Coming Soon
              </button>
            </div>
          ...
          <section className="grid grid-cols-1 gap-5 md:grid-cols-3">
            {statCards.map((card) => (
              <div key={card.label} className={smallCardClass}>
                ...
                <h2 className="mt-3 text-3xl font-bold text-[var(--ownly-text)] md:text-4xl">
                  {card.value}
                </h2>

                <p className="mt-3 text-sm text-[var(--ownly-subtle)]">
                  {card.helper}
                </p>
              </div>
            ))}
          ...
          <section className={cardClass}>
            ...
            <div className="space-y-4">
              {payments.length === 0 ? (
                <div className="rounded-2xl border border-dashed border-[var(--ownly-border)] bg-[var(--ownly-surface-soft)] p-6 text-center">
                ...
                payments.map((payment) => {
                  ...
                  return (
                    <div
                      key={payment.id}
                      className="flex flex-col gap-5 rounded-2xl border border-[var(--ownly-border)] bg-[var(--ownly-surface-soft)] p-5 transition-colors duration-200 md:flex-row md:items-center md:justify-between"
                    >
                      <div className="min-w-0">
                        ...
                        <p className="mt-2 text-sm text-[var(--ownly-subtle)]">
                      ...
                      <div className="flex flex-col gap-3 md:items-end">
                        <h2 className="text-3xl font-bold text-[var(--ownly-text)]">
